			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="pname" title="${message(code: 'package.pname.label', default: 'Pname')}" />
				...
				<g:each in="${packageInstanceList}" status="i" var="packageInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${packageInstance.id}">${fieldValue(bean: packageInstance, field: "pname")}</g:link></td>
