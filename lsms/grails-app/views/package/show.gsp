	...
	<body>
		...
		<div id="show-package" class="content scaffold-show" role="main">
			...
			<ol class="property-list package">
				...
				<g:if test="${packageInstance?.pname}">
				<li class="fieldcontain">
					<span id="pname-label" class="property-label"><g:message code="package.pname.label" default="Pname" /></span>
					
						<span class="property-value" aria-labelledby="pname-label"><g:fieldValue bean="${packageInstance}" field="pname"/></span>
