	...
	<body>
		...
		<div id="show-customer" class="content scaffold-show" role="main">
			...
			<ol class="property-list customer">
				...
				<li class="fieldcontain">
					<span id="middleName-label" class="property-label"><g:message code="customer.middleName.label" default="Middle Name" /></span>
				...
				<g:if test="${customerInstance?.laundry}">
				<li class="fieldcontain">
					<span id="laundry-label" class="property-label"><g:message code="customer.laundry.label" default="Laundry" /></span>
					
						<g:each in="${customerInstance.laundry}" var="l">
						<span class="property-value" aria-labelledby="laundry-label"><g:link controller="laundry" action="show" id="${l.id}">${l?.encodeAsHTML()}</g:link></span>
						</g:each>
