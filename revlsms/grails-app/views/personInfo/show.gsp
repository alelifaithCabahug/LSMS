	...
	<body>
		...
		<div id="show-personInfo" class="content scaffold-show" role="main">
			...
			<ol class="property-list personInfo">
				...
				<g:if test="${personInfoInstance?.middleName}">
				<li class="fieldcontain">
					<span id="middleName-label" class="property-label"><g:message code="personInfo.middleName.label" default="Middle Name" /></span>
					
						<span class="property-value" aria-labelledby="middleName-label"><g:fieldValue bean="${personInfoInstance}" field="middleName"/></span>
				...
				<g:if test="${personInfoInstance?.contact}">
				<li class="fieldcontain">
					<span id="contact-label" class="property-label"><g:message code="personInfo.contact.label" default="Contact" /></span>
					
						<span class="property-value" aria-labelledby="contact-label"><g:fieldValue bean="${personInfoInstance}" field="contact"/></span>
